...
urlpatterns = [
    ...
    re_path(r'^single/$', nviews.SingleView.as_view(), name='single-node'),
    re_path(r'^filter/$', nviews.FilterView.as_view(), name='filter-list'),
    re_path(r'^nodes/$', nviews.NodeListAPIView.as_view(), name='node-list'),
